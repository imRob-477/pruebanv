/* Generated automatically from /workspaces/pruebanv/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/hostpython3/desktop/hostpython3/Modules/config.c.in by makesetup. */
