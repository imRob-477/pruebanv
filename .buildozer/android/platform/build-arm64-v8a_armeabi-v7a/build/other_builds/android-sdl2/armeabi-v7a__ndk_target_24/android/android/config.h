...
#define IS_SDL3 0
#define PY2 0
#define ANDROID_LIBS_DIR "/workspaces/pruebanv/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/myapp/armeabi-v7a:/workspaces/pruebanv/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/bootstrap_builds/sdl2/obj/local/armeabi-v7a"
